import { ORDER_STATUS, readOrderHistory } from "../orders/order-storage";
...
export function getReviewEligibility(productId) {
  ...
  if (activeOrder) {
    return {
      ...
      message: `Aap ka order abhi "${activeOrder.status}" hai. Review tab de sakte hain jab parcel deliver ho jaye.`,
    };
  }
